 ...
 *   <script src="footer.js" data-page="auth"></script>  ← нет мобильного меню
...
(function () {
  ...
  const CSS = `
    ...
    /* Мобильный навбар — только для публичных страниц */
    .antviz-mobile-nav {
      display: none;
      position: fixed;
      bottom: 16px;
    ...
    /* Для страниц без мобильного меню — нормальный отступ */
