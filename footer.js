...
(function () {
  ...
  function buildFooter(activePage, base) {
    const b = base || '';
    ...
    <div class="antviz-footer__top">
      ...
      <div>
        ...
        <nav class="antviz-footer__col-links">
          ...
          <a href="mailto:support@antviz.ru">support@antviz.ru</a>
          <span style="color:#3a3a4a; font-size:.7rem; margin-top:-5px;">Ответим только в чате на сайте</span>
