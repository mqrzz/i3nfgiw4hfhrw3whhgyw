...
const NOTIFY_CONFIG = {
  ...
  title: 'Полностью изменили меню',            // крупный заголовок
  text: 'Обновили меню в обеих версиях — и на ПК, и на мобильных. Версия для десктопа тоже не осталась в стороне: мы добавили новые функции.', // текст под заголовком
