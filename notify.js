...
const NOTIFY_CONFIG = {
  ...
  title: 'Изменили страницу заказа',            // крупный заголовок
  text: 'Теперь все стало еще удобнее - убрали баги, а также добавили недостающие детали.', // текст под заголовком
  ...
  secondaryHref: 'https://antviz.ru/order',
