...
const NOTIFY_CONFIG = {
  ...
  title: 'Кабинет обновился',            // крупный заголовок
  text: 'Единый стиль с сайтом, десктопная раскладка вместо растянутой мобильной.', // текст под заголовком
  ...
  secondaryHref: 'blog.antviz.ru/changelog',
