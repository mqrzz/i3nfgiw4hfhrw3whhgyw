...
const NOTIFY_CONFIG = {
  ...
  title: 'Изменены Правила сервиса',            // крупный заголовок
  text: 'После перехода на новый платёжный агрегатор мы обновили Правила. Ознакомиться с ними можно по ссылке ниже.', // текст под заголовком
  ...
  secondaryHref: 'https://antviz.ru/rules',
